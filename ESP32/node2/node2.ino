...
#define DEVICE_NAME      "node2" //替换自己的DEVICE_NAME
#define DEVICE_SECRET    "c98b1029ef80a36910801e01376a1984b"//替换自己的DEVICE_SECRET
 //以下不需修改
...
void setup() {
  ...
  tim1.attach(3, sendData); //定时每秒调用一次发送数据函数sendTempAndHumi
